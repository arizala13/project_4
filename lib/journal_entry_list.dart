...
class JournalEntriesScreen extends StatelessWidget {
      ...
      'subtitle': 'Subtitle text for $i',
              ...
              Widget build(BuildContext context) {
                ...
                MaterialPageRoute(builder: (context) => JournalEntryForm()),
                  ...
                  appBar:AppBar (title: Text('Journal Entries', style:(Theme.of(context).textTheme.title)),) ,
                  body: ListView.builder(
                    ...
                    return ListTile(
                        ...
                        subtitle: Text('Journal Entry ${items[index]['title']}', style:(Theme.of(context).textTheme.title)),
                        );
                  }
                  ),
                        endDrawer: Drawer(
  ...
  // class JournalEntriesScreen extends State<JournalEntriesScreen> {
